...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5245c67eb7015157c01f18f48cc53f82) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Jay LeCavalier <jay.lecavalier@colorado.edu>"];
          homepage = None;
          synopsis =
            "A SAT solver which employs the CDCL resolution procedure";
          description = Some [OASISText.Para "CamLogic is a SAT solver"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Sys_parser"; "Sys_lexer"; "ParserUtils"; "Cdcl"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "h\024j\228\141z\197\164\195pq\021\238k.\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
